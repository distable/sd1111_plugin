...
all_samplers = [
    *[
        ...
        for label, funcname, aliases, options in [
            ...
            ('DPM2 a', 'sample_dpm_2_ancestral', ['dpm2-a', 'k_dpm_2_a'], {}),
            ('DPM fast', 'sample_dpm_fast', ['dpm-fast', 'k_dpm_fast'], {}),
            ('DPM adaptive', 'sample_dpm_adaptive', ['dpm-ad', 'k_dpm_ad'], {}),
            ('LMS Karras', 'sample_lms', ['lms-ka', 'k_lms_ka'], {'scheduler': 'karras'}),
            ('DPM2 Karras', 'sample_dpm_2', ['dpm2-ka', 'k_dpm_2_ka'], {'scheduler': 'karras'}),
            ('DPM2 a Karras', 'sample_dpm_2_ancestral', ['dpm2-a-ka', 'k_dpm_2_a_ka'], {'scheduler': 'karras'}),
            ('DPM++ 2S a', 'sample_dpmpp_2s_ancestral', ['dpmpp-2s-a', 'k_dpmpp_2s_a'], {}),
            ('DPM++ 2M', 'sample_dpmpp_2m', ['dpmpp-2m', 'k_dpmpp_2m'], {}),
            ('DPM++ 2S a Karras', 'sample_dpmpp_2s_ancestral', ['dpmpp-2s-a-ka', 'k_dpmpp_2s_a_ka'], {'scheduler': 'karras'}),
            ('DPM++ 2M Karras', 'sample_dpmpp_2m', ['dpmpp-2m-ka', 'k_dpmpp_2m_ka'], {'scheduler': 'karras'}),
